...
.version:
	@echo "[Updating react-component_input version]"
...
build-docs:
	...
	@rm -rf _book
	@gitbook build -g dmblack/react-component_input
...
_publish-docs:
	...
	git push git@github.com:dmblack/react-component_input gh-pages --force
