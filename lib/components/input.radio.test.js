...
it("renders without crashing", function () {
  ...
  _reactDom2.default.render(_react2.default.createElement(_Input2.default, { type: "radio", identifier: "testInput", labelContent: "Test Input" }), div);
});

it("should have a html div container", function () {
  var wrapper = (0, _enzyme.shallow)(_react2.default.createElement(_Input2.default, { type: "radio", identifier: "testInput", labelContent: "Test Input" }));
...
it("container has appropriate classes", function () {
  var wrapper = (0, _enzyme.shallow)(_react2.default.createElement(_Input2.default, { type: "radio", identifier: "testInput", labelContent: "Test Input" }));
  var container = wrapper.find("[className='input input-container input-radio container-untouched  container-nofocus container-invalid']");

  expect(container.length).toEqual(1);
});

it("container has appropriate classes when over-ridden with single string", function () {
  var wrapper = (0, _enzyme.shallow)(_react2.default.createElement(_Input2.default, { type: "radio", identifier: "testInput", labelContent: "Test Input", containerClassNames: "reniatnoc" }));
...
it("container has appropriate classes when over-ridden with array of strings", function () {
  var wrapper = (0, _enzyme.shallow)(_react2.default.createElement(_Input2.default, { type: "radio", identifier: "testInput", labelContent: "Test Input", containerClassNames: ["reniatnoc", "reniatno"] }));
...
it("label should have appropraite classes when over-ridden with an array of strings", function () {
  var wrapper = (0, _enzyme.shallow)(_react2.default.createElement(_Input2.default, { type: "radio", identifier: "testInput", labelContent: "Test Input", labelClassNames: ["lebal", "leba"] }));
...
it("input should have appropriate classes when over-ridden with an array of strings", function () {
  var wrapper = (0, _enzyme.shallow)(_react2.default.createElement(_Input2.default, { type: "radio", identifier: "testInput", labelContent: "Test Input", inputClassNames: ["tupni", "tupn"] }));
...
it("p (validation) should have appropriate classes when over-ridden by an array of strings", function () {
  var wrapper = (0, _enzyme.shallow)(_react2.default.createElement(_Input2.default, { type: "radio", identifier: "testInput", labelContent: "Test Input", validationClassNames: ["noitadilav", "noitadila"] }));
