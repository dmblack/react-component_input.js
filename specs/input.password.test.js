...
it("renders without crashing", () => {
  ...
  ReactDOM.render(
    <Input type="password" identifier="testInput" labelContent="Test Input" />,
    div
  );
});
...
it("container has appropriate classes", () => {
  ...
  let container = wrapper.find(
    "[className='input input-container input-password input-untouched input-nofocus input-novalidation']"
  );
...
it("container has appropriate classes when over-ridden with single string", () => {
  ...
  let container = wrapper.find(
    "[className='reniatnoc reniatnoc-container reniatnoc-password reniatnoc-untouched reniatnoc-nofocus reniatnoc-novalidation']"
  );
...
it("container has appropriate classes when over-ridden with array of strings", () => {
  ...
  let container = wrapper.find(
    "[className='reniatnoc reniatnoc-container reniatnoc-password reniatnoc-untouched reniatnoc-nofocus reniatnoc-novalidation reniatno reniatno-container reniatno-password reniatno-untouched reniatno-nofocus reniatno-novalidation']"
  );
...
it("label should have appropraite classes", () => {
  ...
  let label = wrapper.find(
    "[className='label label-container label-password label-untouched label-nofocus label-novalidation']"
  );
...
it("label should have appropraite classes when over-ridden with an array of strings", () => {
  ...
  let label = wrapper.find(
    "[className='lebal lebal-container lebal-password lebal-untouched lebal-nofocus lebal-novalidation leba leba-container leba-password leba-untouched leba-nofocus leba-novalidation']"
  );
...
it("input should have appropriate classes when over-ridden with an array of strings", () => {
  ...
  let input = wrapper.find(
    "[className='tupni tupni-container tupni-password tupni-untouched tupni-nofocus tupni-novalidation tupn tupn-container tupn-password tupn-untouched tupn-nofocus tupn-novalidation']"
  );
...
it("p (validation) should have appropriate classes", () => {
  ...
  let input = wrapper.find(
    "[className='validation validation-container validation-password validation-untouched validation-nofocus validation-validation validation-invalid']"
  );
...
it("p (validation) should have appropriate classes when over-ridden by an array of strings", () => {
  ...
  let input = wrapper.find(
    "[className='noitadilav noitadilav-container noitadilav-password noitadilav-untouched noitadilav-nofocus noitadilav-validation noitadilav-invalid noitadila noitadila-container noitadila-password noitadila-untouched noitadila-nofocus noitadila-validation noitadila-invalid']"
  );

  expect(input.length).toEqual(1);
});

it("accepts, and renders, name property password", () => {
  const wrapper = shallow(
    <Input
      type="password"
      identifier="testInput"
...
it("accepts, and renders, name property password - control (ensures no false positive)", () => {
  const wrapper = shallow(
    <Input
      type="password"
      identifier="testInput"
...
it("accepts, and renders, placeholder property password", () => {
  const wrapper = shallow(
    <Input
      type="password"
      identifier="testInput"
...
it("accepts, and renders, placeholder property password - control (ensures no false positive)", () => {
  const wrapper = shallow(
    <Input
      type="password"
      identifier="testInput"
...
it("component contains a password-nofocus class default", () => {
  const wrapper = shallow(
    <Input type="password" identifier="testInput" labelContent="Test Input" />
  );

  let hasNoFocus = wrapper.find(".password-nofocus");

  expect(hasNoFocus.length).toEqual(1);
});

it("component contains a password-focus class upon receiving focus", () => {
  const wrapper = shallow(
    <Input type="password" identifier="testInput" labelContent="Test Input" />
  );
  ...
  let nowHasFocus = wrapper.find(".password-focus");

  expect(nowHasFocus.length).toEqual(1);
});

it("component contains a password-nofocus class upon receiving focus, then again losing focus", () => {
  const wrapper = shallow(
    <Input type="password" identifier="testInput" labelContent="Test Input" />
  );
  ...
  let noLongerHasFocus = wrapper.find(".password-nofocus");
  expect(noLongerHasFocus.length).toEqual(1);
});

it("component contains a password-untouched class default", () => {
  const wrapper = shallow(
    <Input type="password" identifier="testInput" labelContent="Test Input" />
  );

  let hasNoTouched = wrapper.find(".password-untouched");

  expect(hasNoTouched.length).toEqual(1);
});

it("component contains a password-focus class upon change (touched)", () => {
  const wrapper = shallow(
    <Input type="password" identifier="testInput" labelContent="Test Input" />
  );
  ...
  let nowHasTouched = wrapper.find(".password-touched");

  expect(nowHasTouched.length).toEqual(1);
});

it("component contains a password-untouched class upon change (Touched), and is retained on blur", () => {
  const wrapper = shallow(
    <Input type="password" identifier="testInput" labelContent="Test Input" />
  );
  ...
  wrapper.find("input").simulate("blur");
  let stillRetainsTouched = wrapper.find(".password-touched");
  expect(stillRetainsTouched.length).toEqual(1);
});

it("component accepts disabled propery, which inhibits changing value", () => {
  const wrapper = shallow(
    <Input type="password" identifier="testInput" labelContent="Test Input" disabled={true}/>
  );
  ...
  let nowHasTouched = wrapper.find(".password-untouched");
