...
it("container has appropriate classes", () => {
  ...
  let container = wrapper.find("[className='input input-container input-radio container-untouched  container-nofocus container-invalid']");
...
it("p (validation) should have appropriate classes when over-ridden by an array of strings", () => {
  const wrapper = shallow(
    <Input type="radio" identifier="testInput" labelContent="Test Input" validationClassNames={["noitadilav", "noitadila"]}/>
  );
